...
{
	{
		...
		L_1 = UnityWebRequest_Get_m742DAB13AD092C42430625D3857FC207986D3967(L_0, /*hidden argument*/NULL);
...
IL_0017:
	{
		...
		NullCheck(L_3);
		int32_t L_4;
		L_4 = UnityWebRequest_get_result_m4E9272AB25BD5CE7B927F4B1873763510476BDC6(L_3, /*hidden argument*/NULL);
	...
	}
	{
		...
		NullCheck(L_6);
		String_t* L_7;
		L_7 = UnityWebRequest_get_error_m32B69D2365C1FE2310B5936C7C295B71A92CC2B4(L_6, /*hidden argument*/NULL);
		V_1 = L_7;
		goto IL_0087;
	}
...
IL_0037:
	{
		...
		NullCheck(L_8);
		int64_t L_9;
		L_9 = UnityWebRequest_get_responseCode_m27D1260ADC92070608532D81B836CAA2742D1753(L_8, /*hidden argument*/NULL);
	...
	}
	{
		...
		NullCheck(L_11);
		int64_t L_12;
		L_12 = UnityWebRequest_get_responseCode_m27D1260ADC92070608532D81B836CAA2742D1753(L_11, /*hidden argument*/NULL);
		String_t* L_13;
		L_13 = UnityWebRequest_GetHTTPStatusString_m3DC28439F607E54EAAE7B423F1FB5DE9A2C1E199(L_12, /*hidden argument*/NULL);
		V_4 = L_13;
		UnityWebRequest_tB75B39F6951CA0DBA2D5BEDF85FDCAAC6026A37E * L_14 = __this->get__uwr_0();
		NullCheck(L_14);
		int64_t L_15;
		L_15 = UnityWebRequest_get_responseCode_m27D1260ADC92070608532D81B836CAA2742D1753(L_14, /*hidden argument*/NULL);
		int64_t L_16 = L_15;
		RuntimeObject * L_17 = Box(Int64_t378EE0D608BD3107E77238E85F30D2BBD46981F3_il2cpp_TypeInfo_var, &L_16);
		String_t* L_18 = V_4;
		String_t* L_19;
		L_19 = String_Format_m8464C6DD7299114954DA87FC39FCD129F3E2ACA2(_stringLiteral8E752B76D455A50FE476984D4B09A7CDBF2A753E, L_17, L_18, /*hidden argument*/NULL);
		V_1 = L_19;
		goto IL_0087;
	}
...
IL_0044:
	{
		...
		Debug_LogError_m5952BCE5DC0EF798B31FA983B9CE42A5A1F82DE1(_stringLiteralE2429764F10DC7E990250D2AE4138FE5AC928076, /*hidden argument*/NULL);
		V_1 = (bool)0;
		goto IL_0054;
	}
